...
function preload(){
    ...
    bestManIsNoob = loadImage("bat/Bestman-01.png");
...
function setup(){
    ...
    bestMan = createSprite(200,550,20,20);
    bestMan.addImage(bestManIsNoob);
    bestMan.scale=0.16;
